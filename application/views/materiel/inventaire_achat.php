<div class="p-1">
    ...
    <div class="card">
        <div class="col-10 mb-2 d-flex align-items-center">
            <h4 class="me-4">Inventaire des matériels achetés</h4> <a href="<?php echo site_url("materiel/inventaire/location"); ?>" class="link-redirect"><i class="fa-regular fa-hand-pointer"></i> Historique des locations ici</a>
        </div>
