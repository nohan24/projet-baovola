    ...
    <div class="card">
        <div class="row">
            <div class="col-10 mb-2 d-flex align-items-center">
                <h4 class="me-4">Mouvement d'entrée</h4> <a href="<?php echo site_url("stock/mouvement/sortie"); ?>" class="link-redirect"><i class="fa-regular fa-hand-pointer"></i> Mouvement de sortie ici</a>
            </div>
